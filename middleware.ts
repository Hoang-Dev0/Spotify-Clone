...
export const middleware = async (request: NextRequest) => {
  ...
  // could replace by way using jsonwebtoken
  ...
  // OR (3) it is a request to '/next' (/_next/static) (nơi chứa các page được render ra)
  ...
  // (1) user doesn't  have a token AND (2) is requesting protected route
